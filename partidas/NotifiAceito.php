	...
	echo "	<div class='col s12 m6'>
				<div class='card yellow darken-2'>
					<div class='card-content white-text'>
						...
						<p> <b>".$Desafiante[0]."</b> <b><u>aceitou</b></u> seu desafio para o dia: <b>".implode("/", array_reverse(explode("-",$RecebePartida[1])))."</b>, no horário: <b>".$RecebePartida[2]."</b>, em campo: <b>".$campo."</b>, endereço: Rua <b>".$RecebePartida[3]."</b>, Nº <b>".$RecebePartida[4]."</b>, <b>".$RecebePartida[5]."</b>, <b>".$RecebePartida[6]."</b>.</p>
					</div>
					<div class='card-action' style='border-top:solid #e64a19;'>
						<button type='submit' class='btn-floating blue darken-1 waves-effect waves-blue' name='VisualizaNotifiAceito' value=".$RecebeNotificacao[0]."><i class='material-icons'>done</i></button>
					</div>
				</div>
			</div>";
?>